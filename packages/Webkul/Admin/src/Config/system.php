...
return [
    ...
    [
        ...
        'key'    => 'customer.address.display',
        'name'   => 'admin::app.configuration.index.customer.address.display.title',
        'info'   => 'admin::app.configuration.index.customer.address.display.title-info',
        'sort'   => 2,
        'fields' => [
            [
                'name'          => 'company_name',
                'title'         => 'admin::app.configuration.index.customer.address.display.company-name',
                'type'          => 'boolean',
                'channel_based' => true,
                'default'       => 0,
            ], [
                'name'          => 'email',
                'title'         => 'admin::app.configuration.index.customer.address.display.email',
                'type'          => 'boolean',
                'channel_based' => true,
                'default'       => 1,
            ], [
                'name'          => 'country',
                'title'         => 'admin::app.configuration.index.customer.address.display.country',
                'type'          => 'boolean',
                'channel_based' => true,
                'default'       => 1,
            ], [
                'name'          => 'state',
                'title'         => 'admin::app.configuration.index.customer.address.display.state',
                'type'          => 'boolean',
                'channel_based' => true,
                'default'       => 1,
            ], [
                'name'          => 'city',
                'title'         => 'admin::app.configuration.index.customer.address.display.city',
                'type'          => 'boolean',
                'channel_based' => true,
                'default'       => 1,
            ], [
                'name'          => 'postcode',
                'title'         => 'admin::app.configuration.index.customer.address.display.zip',
                'type'          => 'boolean',
                'channel_based' => true,
                'default'       => 1,
            ],
        ...
        'fields' => [
            [
                'name'          => 'split_name',
                'title'         => 'admin::app.configuration.index.customer.address.information.split-name',
                'type'          => 'boolean',
                'channel_based' => true,
                'default'       => 0,
            ], [
    ...
    [
        ...
        'key'    => 'sales.carriers.insidecity',
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.title-info',
        'sort'   => 2,
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.title',
                'type'          => 'text',
                'channel_based' => true,
                'locale_based'  => true,
            ], [
                'name'          => 'description',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.description',
                'type'          => 'textarea',
                'channel_based' => true,
                'locale_based'  => true,
            ], [
                'name'          => 'default_rate',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.rate',
                'type'          => 'text',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'    => 'type',
                'title'   => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.type.title',
                'type'    => 'select',
                'options' => [
                    [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.type.per-unit',
                        'value' => 'per_unit',
                    ], [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.inside-city-shipping.type.per-order',
                        'value' => 'per_order',
                    ],
                ],
                'channel_based' => true,
        ...
        'key'    => 'sales.carriers.outsidecity',
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.title-info',
        'sort'   => 2,
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.title',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => true,
                ...
                'name'          => 'description',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.description',
                'type'          => 'textarea',
                'channel_based' => true,
                'locale_based'  => true,
            ], [
                'name'          => 'default_rate',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.rate',
                'type'          => 'text',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'    => 'type',
                'title'   => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.type.title',
                'type'    => 'select',
                'options' => [
                    [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.type.per-unit',
                        'value' => 'per_unit',
                    ], [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.outside-city-shipping.type.per-order',
                        'value' => 'per_order',
                    ],
                ],
                'channel_based' => true,
        ...
        'key'    => 'sales.carriers.simple',
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.title-info',
        'sort'   => 2,
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.title',
                'type'          => 'text',
                'default'       => 'Simple',
                'depends'       => 'active:1',
                'validation'    => 'required',
                ...
                'name'          => 'description',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.description',
                'type'          => 'textarea',
                'default'       => 'Simple Shipping',
                'channel_based' => true,
                'locale_based'  => true,
            ],[
                'name'          => 'inside_city_label',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.label.inside-city',
                'type'          => 'text',
                ...
                'name'          => 'outside_city_label',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.label.outside-city',
                'type'          => 'text',
                ...
                'name'          => 'inside_city_cost',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.cost.inside-city',
                'type'          => 'number',
                'default'       => 70,
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                ...
                'name'          => 'outside_city_cost',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.cost.outside-city',
                'type'          => 'number',
                'default'       => 130,
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                ...
                'name'    => 'type',
                'title'   => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.type.title',
                'type'    => 'select',
                'default' => 'per_order',
                'options' => [
                    [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.type.per-unit',
                        'value' => 'per_unit',
                    ], [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.type.per-order',
                        'value' => 'per_order',
                    ],
                ],
                'channel_based' => true,
                ...
                'name'          => 'active',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.simple-shipping.status',
                'type'          => 'boolean',
                'channel_based' => true,
                'locale_based'  => false,
            ],
        ...
        'fields' => [
            [
                ...
                'name'    => 'allow_simple_checkout',
                'title'   => 'admin::app.configuration.index.sales.checkout.shopping-cart.simple-checkout',
                'info'    => 'admin::app.configuration.index.sales.checkout.shopping-cart.simple-checkout-info',
                'depends' => 'allow_guest_checkout:1',
                'type'    => 'boolean',
                'default' => 1,
            ], [
                'name'    => 'cart_page',
