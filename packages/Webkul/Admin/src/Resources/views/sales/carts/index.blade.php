<x-admin::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('admin::app.sales.carts.index.title')
    </x-slot>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            <x-admin::datagrid.export src="{{ route('admin.sales.carts.index') }}" />
        </div>
    </div>

    <v-customer-search ref="selectCustomerComponent"></v-customer-search>

    <x-admin::datagrid :src="route('admin.sales.carts.index')" :isMultiRow="true">
        <template #header="{
            isLoading,
            available,
            applied,
            ...
            <template v-else>
                <div class="row grid grid-cols-4 grid-rows-1 items-center border-b px-4 py-2.5 dark:border-gray-800">
                    <div
                        ...
                        v-for="(columnGroup, index) in [['id', 'created_at'], ['base_grand_total', 'channel_id'], ['full_name', 'customer_phone'], ['items']]"
                    >
            ...
            <template v-else>
                ...
                >
                    ...
                    <div class="">
                        <div class="flex gap-2.5">
                            <div class="flex flex-col gap-1.5">
                                ...
                                >
                                    @{{ "@lang('admin::app.sales.carts.index.datagrid.id')".replace(':id', record.id) }}
                                </p>
                    ...
                    <div class="flex items-center justify-between gap-x-2">
                        ...
                        <a :href=`{{ route('admin.sales.carts.view', '') }}/${record.id}`>
